...
import com.OnlineMedicalShop.exception.MedicineIdDoesNotExistException;
...
public class MedicineServiceImpl implements MedicineService{
	...
	@Override
	public Medicine viewMedicineById(int medicineId) throws MedicineIdDoesNotExistException {
		// TODO Auto-generated method stub
			Optional<Medicine>med=medrepo.findById(medicineId);
			if(med.isPresent())
			{
				return med.get();
			}
			throw new MedicineIdDoesNotExistException();
